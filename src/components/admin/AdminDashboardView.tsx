    ...
    <div className="max-w-6xl mx-auto animate-in fade-in duration-500">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500">
            Manage users, subscriptions, and system settings securely.
          </p>
        </div>
      </div>
          ...
          {activeSubTab === "overview" && stats && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div className="text-3xl font-bold text-slate-900">
                  {stats.metrics.activeSubscriptions}
                </div>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex items-center gap-3 mb-2 text-slate-500">
                    ...
                    <tr key={u.id} className="hover:bg-slate-50">
                      ...
                      <td className="p-4">
                        ...
                        {u.billing?.lifetimeAccess && (
                          <span className="inline-block ml-2 px-2 py-1 bg-amber-100 text-amber-800 rounded text-xs font-bold">
                            LIFETIME
                          </span>
                        )}
                        {u.billing?.earlyAccessExpiresAt &&
                          new Date(u.billing.earlyAccessExpiresAt) >
                            new Date() && (
                            <span className="inline-block ml-2 px-2 py-1 bg-purple-100 text-purple-800 rounded text-xs font-bold">
                              EARLY ACCESS
                            </span>
                          )}
                      </td>
                      ...
                      <td className="p-4 text-right space-x-2">
                        <button
                          onClick={() =>
                            grantAccess(u.id, "grant_early_access")
                          }
